...
import com.sbouhaddi.services.CategoryService;
...
public class CategoryControllerTest {
	...
	public void testGetByNameCategories() throws Exception {
		...
		mockMvc.perform(get(CategoryController.BASE_URL + "/Sabri").contentType(MediaType.APPLICATION_JSON))
